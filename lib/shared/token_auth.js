    ...
    middleware: [
      ...
      async function findClientId(ctx, next) {
        ...
        if (ctx.headers.authorization !== undefined) {
          console.log(`[jmh] if (ctx.headers.authorization !== undefined) > ctx.headers.authorization[${ctx.headers.authorization}]`);
          ...
          console.log(`[jmh] else if (clientId !== undefined) > clientId[${clientId}]`);
        ...
        console.log(`[jmh] ctx.oidc.authorization.clientId[${ctx.oidc.authorization.clientId}]`);
