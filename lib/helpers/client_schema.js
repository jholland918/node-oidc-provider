...
module.exports = function getSchema(provider) {
  ...
  class Schema {
    constructor(
      ...
      console.log(`[jmh]   DEFAULT[${DEFAULT}]`);
      console.log(`[jmh]   RECOGNIZED_METADATA[${RECOGNIZED_METADATA}]`);
      console.log(`[jmh]   configuration.extraClientMetadata.properties[${configuration.extraClientMetadata.properties}]`);
      ...
      console.log(`[jmh] assigned to this[${debug1}]`);
