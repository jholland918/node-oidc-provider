    ...
    middleware: [
      ...
      async function findClientId(ctx, next) {
        ...
        if (clientAssertion !== undefined) {
          ...
          throw new InvalidRequest(`clientAssertion[${clientAssertion}]`);
          ...
          if (clientId && sub !== clientId) {
            throw new InvalidRequest(`subject[${sub}] of client_assertion must be the same as client_id[${clientId}] provided in the body`);
          }
